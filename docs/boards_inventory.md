...
| `antmicro_ddr5_test_board` | antmicro_ddr5_test_board | vivado | `200000000.0` | Ethernet, Etherbone, SDCard | Requires a LiteDRAM checkout with litedram.phy.ddr5. |
...
| `trenz_tel0025` | trenz_tel0025 | radiant | `75000000.0` | SDCard, SPI SDCard, SPI Flash | included |
